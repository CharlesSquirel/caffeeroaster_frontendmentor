...
export default function WorksItem({
  ...
  return (
    <div
      className={`${isLast ? 'mb-[79px] md:mb-0' : 'mb-[56px] md:mb-0 md:mr-[10px]'} flex w-[327px] flex-col gap-[24px] md:w-[223px] md:gap-[40px]`}
    >
      <p
      ...
      <p className="text-center text-[15px] leading-[25px] text-blueDark md:text-start">
        {description}
      </p>
    </div>
  );
