...
export default function HeroAbout() {
  return (
    <article className="mb-[120px] flex h-[400px] w-[327px] flex-col gap-[24px] rounded-[10px] bg-[url('/hero_about_mobile.webp')] bg-cover px-[24px] pb-[87px] pt-[111px] text-cream md:mb-[144px] md:h-[400px] md:w-[689px] md:bg-[url('/hero_about_tablet.webp')] md:py-[118px] md:pl-[58px] md:pr-[233px] xl:mb-[168px] xl:h-[450px] xl:w-[1280px] xl:bg-[url('/hero_about_desktop.jpg')] xl:py-[137px] xl:pl-[87px] xl:pr-[750px]">
      <h2
