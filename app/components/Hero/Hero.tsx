...
export default function Hero() {
  return (
    <article className="mb-[144px] flex h-[500px] w-[327px] flex-col items-center rounded-[10px] bg-[url('/hero_mobile.jpg')] bg-cover px-[24px] py-[100px] text-cream sm:h-[500px] md:mb-[136px] md:w-[689px] md:items-start md:bg-[url('/hero_tablet.jpg')] md:pl-[58px] md:pr-[233px] xl:h-[600px] xl:w-[1280px] xl:bg-[url('/hero_desktop.jpg')] xl:py-[117px] xl:pl-[85px] xl:pr-[702px]">
      <h2
